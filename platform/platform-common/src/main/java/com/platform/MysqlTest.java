...
public class MysqlTest {
     ...
     * 数据库url
     */
    private static final String URL = "jdbc:mysql://120.26.29.225:3306/platform-shop";
    /**
     * 用户名
     */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String sql = "SELECT  job_id,bean_name,method_name,params,cron_expression,status,remark,create_time  FROM SCHEDULE_JOB";
